    ...
    <div className="flex gap-2 mt-3">
      {malId && (
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-3 py-2 backdrop-blur-xl bg-blue-500/20 hover:bg-blue-500/30 border border-blue-400/30 rounded-lg text-white text-sm transition-all"
        >
          ...
          <span>MAL</span>
          {malRating && (
            <span className="px-2 py-0.5 bg-yellow-500/30 rounded text-xs font-semibold">
              {malRating}
            </span>
          )}
      ...
      {anilistId && (
        <motion.a
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-3 py-2 backdrop-blur-xl bg-purple-500/20 hover:bg-purple-500/30 border border-purple-400/30 rounded-lg text-white text-sm transition-all"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
